...
class NormalDataset(Dataset):
    ...
    def build_metas(self):
        ...
        if self.split == 'test':
            list_txt = os.path.join(self.root_dir, 'lists/testing_list.txt')
        ...
        for scan in self.scans:
            ...
            for vid in self.ref_views_per_scan[scan]:
                ...
                img_filename = os.path.join(self.root_dir,
                                            f'{scan}/images_mvsnet/{vid:08d}.jpg')
                ...
                self.proj_mats[scan][vid] = (proj_mat_ls, depth_min, proj_ls)
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            proj_mat_ls, depth_min, proj_ls = self.proj_mats[scan][vid]
